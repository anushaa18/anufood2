...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
     ...
     <div class="sideright">
          ...
          <img src='side/sr2.jpeg' width='380px'  height='870px'/>
        ...
        <a href="disco.php"> <button   class="box2">Discover</button></a>
         ...
         <button class="box3" >Timeline</button>
 ...
 $start_from=($page-1) * $per_page;
        ...
        $u=$_SESSION['email'];
        $get_posts="select * from posts where email='$u' ORDER by 1 DESC LIMIT $start_from,$per_page  ";
      ...
      while( $row1= mysqli_fetch_array($run_user1)){
        ...
        echo"
             <figure>
             <a href='postdetails.php?id= $fid;'>
           <img src='uploads/$un' height='200px' width='300px'></a>
        <figcaption>$pc </figcaption>
  <a href='delete.php?id= $fid;'><button class='btn btn-outline-secondary my-2 my-sm-0' >Delete</button></a>
<a href='postdetails.php?id= $fid;'> <button class='btn btn-outline-success my-2 my-sm-0' >View</button></a>
    
<a href='editpost.php?id= $fid;'><button class='btn btn-outline-primary my-2 my-sm-0' >Edit</button></a>
    </figure>
