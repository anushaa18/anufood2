...
<ul class="nav nav-pills">
  <li class="nav-item">
      <a class="nav-link " href="vegan.php">Vegan</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
      <a class="nav-link active" href="dessert.php">Desserts</a>
  </li>
</ul>
  </ul>
...
<div id="columns">
 ...
 $start_from=($page-1) * $per_page;
        ...
        $u=$_SESSION['email'];
        $get_posts="select * from recipes where Category='Dessert' ORDER by 1 DESC LIMIT $start_from,$per_page  ";
        $run_user1= mysqli_query($con,$get_posts);
